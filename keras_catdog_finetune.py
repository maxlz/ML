...
train_data.class_mode = 'binary'
test_data.class_mode = 'binary'

model.fit_generator(generator=train_data,samples_per_epoch=800,nb_epoch=50,validation_data=test_data,nb_val_samples=400)
