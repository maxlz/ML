...
,save_to_dir='./data/argumented',save_prefix='arg_'):
    i+=1
    if i>4:
        break
...
for i in range(5):
    print i
    datagen.flow(x,batch_size=1,save_prefix='arg_'
    ,save_to_dir='./data/argumented')
'''    
...
model.fit_generator(train_flow,samples_per_epoch=2000,nb_epoch=50
,validation_data = test_flow,nb_val_samples=1000)
